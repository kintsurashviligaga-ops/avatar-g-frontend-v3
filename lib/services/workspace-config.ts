...
export const SERVICE_WORKSPACE_CONFIGS: Record<string, ServiceWorkspaceConfig> = {
  ...
  /* ─── 12. AGENT G — Central Command Layer ──────────────────────── */
  'agent-g': {
    serviceId: 'agent-g',
    welcomeHint: {
      en: 'Your AI command center — route tasks, chain services, orchestrate everything',
      ka: 'შენი AI ხელმძღვანელი — მართე ამოცანები, დააკავშირე სერვისები',
      ru: 'Ваш AI-командный центр — маршрутизация задач и оркестрация',
    },
    outputLabel: { en: 'Agent G Output', ka: 'Agent G შედეგი', ru: 'Результат Agent G' },
    menuItems: [
      { id: 'full-task', icon: '🎯', label: { en: 'Plan Full Task', ka: 'სრული დავალება', ru: 'Полная задача' }, action: 'preset', prompt: 'Plan and execute a complete multi-service task end-to-end' },
      { id: 'quality', icon: '✅', label: { en: 'Quality Review', ka: 'ხარისხის შემოწმება', ru: 'Проверка качества' }, action: 'preset', prompt: 'Review and quality-check all my recent outputs across services' },
      { id: 'bundle', icon: '📦', label: { en: 'Bundle Execution', ka: 'პარტიული გაშვება', ru: 'Пакетный запуск' }, action: 'preset', prompt: 'Execute a batch of tasks across multiple services simultaneously' },
      { id: 'resume', icon: '↩️', label: { en: 'Resume Work', ka: 'სამუშაოს გაგრძელება', ru: 'Продолжить работу' }, action: 'preset', prompt: 'Show me my recent work and let me continue where I left off' },
      { id: 'suggest', icon: '💡', label: { en: 'Suggest Next Steps', ka: 'რეკომენდაციები', ru: 'Рекомендации' }, action: 'preset', prompt: 'Based on my recent work, suggest what I should do next' },
      { id: 'div-nav', icon: '', label: { en: '', ka: '', ru: '' }, action: 'navigate', divider: true },
      { id: 'to-avatar', icon: '👤', label: { en: 'Avatar Studio', ka: 'ავატარ სტუდია', ru: 'Аватар-студия' }, action: 'transfer', target: 'avatar' },
      { id: 'to-video', icon: '🎬', label: { en: 'Video Generation', ka: 'ვიდეო გენერაცია', ru: 'Генерация видео' }, action: 'transfer', target: 'video' },
      { id: 'to-image', icon: '🖼️', label: { en: 'Image / Poster', ka: 'სურათი / პოსტერი', ru: 'Изображение' }, action: 'transfer', target: 'image' },
      { id: 'to-music', icon: '🎵', label: { en: 'Music Production', ka: 'მუსიკის პროდაქშენი', ru: 'Музыка' }, action: 'transfer', target: 'music' },
      { id: 'to-text', icon: '✍️', label: { en: 'Text & Copy', ka: 'ტექსტი და კოპი', ru: 'Текст и копирайтинг' }, action: 'transfer', target: 'text' },
      { id: 'div-more', icon: '', label: { en: '', ka: '', ru: '' }, action: 'navigate', divider: true },
      { id: 'to-editing', icon: '✂️', label: { en: 'Video Editing', ka: 'ვიდეო ედიტინგი', ru: 'Видеомонтаж' }, action: 'transfer', target: 'editing' },
      { id: 'to-photo', icon: '📷', label: { en: 'Photo Enhancement', ka: 'ფოტოს გაუმჯობესება', ru: 'Улучшение фото' }, action: 'transfer', target: 'photo' },
      { id: 'to-workflow', icon: '⚡', label: { en: 'Workflow Builder', ka: 'Workflow ბილდერი', ru: 'Конструктор воркфлоу' }, action: 'transfer', target: 'workflow' },
      { id: 'to-business', icon: '💼', label: { en: 'Business Intelligence', ka: 'ბიზნეს ინტელექტი', ru: 'Бизнес-аналитика' }, action: 'transfer', target: 'business' },
      { id: 'to-shop', icon: '🛒', label: { en: 'Digital Shop', ka: 'ციფრული მაღაზია', ru: 'Цифровой магазин' }, action: 'transfer', target: 'shop' },
    ],
    quickActions: [
      { id: 'avatar', icon: '👤', label: { en: 'Create Avatar', ka: 'ავატარის შექმნა', ru: 'Создать аватар' }, prompt: 'I want to create a professional AI avatar. Guide me through all the options.' },
      { id: 'video', icon: '🎬', label: { en: 'Generate Video', ka: 'ვიდეოს გენერაცია', ru: 'Создать видео' }, prompt: 'I need to generate a cinematic AI video. Help me set up the project.' },
      { id: 'image', icon: '🖼️', label: { en: 'Create Image', ka: 'სურათის შექმნა', ru: 'Создать изображение' }, prompt: 'I want to create an AI-generated image or poster for a campaign.' },
      { id: 'music', icon: '🎵', label: { en: 'Produce Music', ka: 'მუსიკის შექმნა', ru: 'Создать музыку' }, prompt: 'I want to compose original AI music. Help me get started.' },
      { id: 'text', icon: '✍️', label: { en: 'Write Content', ka: 'კონტენტის წერა', ru: 'Написать контент' }, prompt: 'I need to write content — scripts, captions, or marketing copy.' },
      { id: 'workflow', icon: '⚡', label: { en: 'Build Workflow', ka: 'Workflow', ru: 'Воркфлоу' }, prompt: 'I want to build a multi-step AI workflow that chains services together.' },
    ],
    tools: [],
    transfers: [
      { id: 'to-avatar', targetService: 'avatar', icon: '👤', label: { en: 'Avatar', ka: 'ავატარი', ru: 'Аватар' }, description: { en: 'Open Avatar Studio', ka: 'ავატარ სტუდიის გახსნა', ru: 'Открыть аватар-студию' } },
      { id: 'to-video', targetService: 'video', icon: '🎬', label: { en: 'Video', ka: 'ვიდეო', ru: 'Видео' }, description: { en: 'Open Video Generation', ka: 'ვიდეო გენერაციის გახსნა', ru: 'Открыть генерацию видео' } },
      { id: 'to-image', targetService: 'image', icon: '🖼️', label: { en: 'Image', ka: 'სურათი', ru: 'Изображение' }, description: { en: 'Open Image Generation', ka: 'სურათის გენერაციის გახსნა', ru: 'Открыть генерацию изображений' } },
      { id: 'to-music', targetService: 'music', icon: '🎵', label: { en: 'Music', ka: 'მუსიკა', ru: 'Музыка' }, description: { en: 'Open Music Production', ka: 'მუსიკის პროდაქშენის გახსნა', ru: 'Открыть музыкальный продакшн' } },
      { id: 'to-text', targetService: 'text', icon: '✍️', label: { en: 'Text', ka: 'ტექსტი', ru: 'Текст' }, description: { en: 'Open Text & Copy', ka: 'ტექსტის სერვისის გახსნა', ru: 'Открыть текст и копирайтинг' } },
      { id: 'to-workflow', targetService: 'workflow', icon: '⚡', label: { en: 'Workflow', ka: 'Workflow', ru: 'Воркфлоу' }, description: { en: 'Open Workflow Builder', ka: 'Workflow ბილდერის გახსნა', ru: 'Открыть конструктор воркфлоу' } },
    ],
  },
