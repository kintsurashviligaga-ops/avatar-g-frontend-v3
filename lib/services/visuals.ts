...
export const SERVICE_VISUALS: Record<string, ServiceVisualConfig> = {
  ...
  voice: {
    gradient: 'linear-gradient(135deg, #0f1a25 0%, #192d40 50%, #131f2e 100%)',
    gradientLight: 'linear-gradient(135deg, #dbeafe 0%, #bfdbfe 50%, #e0f2fe 100%)',
    accent: '#38bdf8',
    accentSecondary: '#0ea5e9',
    visualIntent: 'AI voice cloning with waveform visualization and vocal synthesis',
    imagePrompt: 'Premium AI voice cloning interface, dynamic audio waveform visualization, microphone with holographic sound waves, voice synthesis dashboard, ElevenLabs-style UI, clean dark audio production environment, professional voice studio setup',
  },
  'content-writer': {
    gradient: 'linear-gradient(135deg, #0d1812 0%, #182a1e 50%, #111f16 100%)',
    gradientLight: 'linear-gradient(135deg, #dcfce7 0%, #d1fae5 50%, #ecfdf5 100%)',
    accent: '#4ade80',
    accentSecondary: '#22c55e',
    visualIntent: 'Premium AI content writing workspace with SEO-structured document output',
    imagePrompt: 'Elegant AI content writing workspace, clean markdown editor with structured blog post, SEO metrics panel, content score indicators, professional copywriting environment, modern dark editor UI',
  },
  'prompt-builder': {
    gradient: 'linear-gradient(135deg, #1a1408 0%, #2a2010 50%, #1f1a0d 100%)',
    gradientLight: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 50%, #fef9c3 100%)',
    accent: '#fbbf24',
    accentSecondary: '#f59e0b',
    visualIntent: 'Structured AI prompt engineering interface with modular blocks',
    imagePrompt: 'Premium prompt engineering dashboard, modular prompt blocks arranged in structured layout, prompt optimization interface, AI instruction system, modern prompt builder workspace',
  },
  podcast: {
    gradient: 'linear-gradient(135deg, #1a0a15 0%, #2e1228 50%, #1f0d1a 100%)',
    gradientLight: 'linear-gradient(135deg, #fce7f3 0%, #fbcfe8 50%, #f5d0fe 100%)',
    accent: '#e879f9',
    accentSecondary: '#d946ef',
    visualIntent: 'AI podcast studio with script generation and multi-speaker setup',
    imagePrompt: 'Premium AI podcast studio, professional microphone setup, script visible on screen, multi-speaker recording environment, soundwave animations, modern podcast production workspace, clean dark UI',
  },
  character: {
    gradient: 'linear-gradient(135deg, #0f0a20 0%, #1e1040 50%, #150d30 100%)',
    gradientLight: 'linear-gradient(135deg, #ede9fe 0%, #ddd6fe 50%, #e0e7ff 100%)',
    accent: '#a78bfa',
    accentSecondary: '#7c3aed',
    visualIntent: 'AI character creation with rich backstory and personality design',
    imagePrompt: 'Premium AI character design studio, holographic character portrait materializing, personality trait cards floating around, backstory timeline, NPC profile interface, creative narrative workspace',
  },
  event: {
    gradient: 'linear-gradient(135deg, #1a0d08 0%, #2e1a10 50%, #1f1208 100%)',
    gradientLight: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 50%, #fed7aa 100%)',
    accent: '#fb923c',
    accentSecondary: '#f97316',
    visualIntent: 'AI event production studio with programs, MC scripts, and invitations',
    imagePrompt: 'Premium AI event production workspace, event program document, MC script on display, elegant invitation mockup, conference stage visualization, modern event planning dashboard, professional event management interface',
  },
  terminal: {
    gradient: 'linear-gradient(135deg, #0d1810 0%, #1a2a1d 50%, #121f15 100%)',
    gradientLight: 'linear-gradient(135deg, #d1fae5 0%, #dcfce7 50%, #ecfdf5 100%)',
    accent: '#34d399',
    accentSecondary: '#10b981',
    visualIntent: 'Premium AI coding terminal with code generation and debugging tools',
    imagePrompt: 'Premium AI coding terminal, elegant code editor with green syntax highlighting, terminal output panel, code generation in progress, modern IDE workspace, dark professional developer environment',
  },
};
