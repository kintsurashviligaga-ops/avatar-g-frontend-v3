...
export const FILM_DRIFT_NEGATIVE =
  ...
  // Master Contract V4 + V8 — anti-collage + physical grounding. Kling/LTX clips inherit this on their native
  // negative_prompt field, so a scene never renders as a split-screen/diptych/comic-grid, and objects stay
  // gravity-grounded (the storyboard FRAMES are guarded separately via a positive single-shot clause since
