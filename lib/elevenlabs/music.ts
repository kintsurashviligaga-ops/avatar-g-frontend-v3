 ...
 */
export function buildElevenMusicPrompt(o: { brief: string; totalSec: number; musicVideoMode?: boolean }): {
  prompt: string;
  instrumental: boolean;
} {
  ...
  const vocalist = female ? 'a female lead vocalist' : 'a lead vocalist';
