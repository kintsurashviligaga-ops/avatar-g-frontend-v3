  ...
  return (
    <section className="min-h-screen bg-transparent flex items-center justify-center px-6" style={{ color: 'var(--color-text)' }}>
      <div className="max-w-2xl text-center space-y-6">
        <h1 className="text-4xl font-bold">About MyAvatar</h1>
        <p className="leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
          MyAvatar is Georgia&apos;s premier AI creative workspace — 16 modules for avatar creation, video production, music, design, business intelligence, tourism, and more.
        </p>
