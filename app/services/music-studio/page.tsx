...
import { 
  ...
  Settings, Sliders, Zap, Headphones, Mic, AudioLines, Music2
} from "lucide-react"
...
const trackTypes = [
  ...
  { id: 'bass', name: 'Bass', icon: <AudioLines size={16} />, color: 'from-orange-500 to-yellow-500', muted: false, solo: false, volume: 75 },
...
const effectsList = [
  ...
  { id: 'delay', name: 'Delay', value: 20, icon: <AudioLines size={16} /> },
