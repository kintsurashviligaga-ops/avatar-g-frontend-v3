...
const AVATAR_STYLES = ["Realistic", "Anime", "Cartoon", "Cyberpunk", "Fantasy"];
const GENDERS = ["Male", "Female", "Neutral"];
const AGES = ["Young", "Adult", "Elderly"];
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-4">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 mb-1.5 block">სქესი</label>
              <select
                value={gender}
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-4">
        ...
        <div>
          <div className="flex justify-between mb-1.5">
            <label className="text-xs text-gray-500">ვარიაციები</label>
            <span className="text-xs text-cyan-400">{variations}</span>
          </div>
          <input
            type="range"
            min={1}
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-4">
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-xs text-gray-400">რეფერენსის გამოყენება</span>
          </label>
        </div>
      </section>
