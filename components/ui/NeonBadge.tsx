...
interface NeonBadgeProps {
  ...
  variant?: 'cyan' | 'violet' | 'magenta' | 'default' // violet kept for API compat
  className?: string
}
...
const colors = {
  ...
  violet:  'bg-cyan-500/[0.10] text-cyan-200 border-cyan-400/25 shadow-[0_0_16px_rgba(34,211,238,0.14),inset_0_1px_0_rgba(255,255,255,0.06)]',
