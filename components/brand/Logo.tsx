...
export function Logo({
  ...
  const LogoIcon = () => (
    <div className={cn(config.container, 'relative overflow-hidden')}>
      <div className="absolute inset-[10%] rounded-full bg-cyan-400/[0.06] blur-xl" />
      <Image
        src="/brand/rocket-brain.svg"
        alt="MyAvatar.ge Rocket"
        fill
        className="object-contain object-center drop-shadow-[0_8px_20px_rgba(34,211,238,0.28)] md:drop-shadow-[0_10px_24px_rgba(34,211,238,0.30)] lg:drop-shadow-[0_12px_28px_rgba(34,211,238,0.32)]"
        sizes="80px"
        priority
      />
    </div>
  ...
  const LogoText = () => (
    <div>
      <h1
        className={cn(
          config.text,
          'font-extrabold tracking-[-0.01em] bg-gradient-to-r from-cyan-400 via-sky-400 to-blue-400 bg-clip-text text-transparent'
        )}
      >
        Avatar G
      </h1>
