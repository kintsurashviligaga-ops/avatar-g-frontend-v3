  ...
  return (
    <section className="relative px-4 sm:px-6 lg:px-10 py-16 sm:py-20 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 70% 50% at 50% 50%, rgba(167,139,250,0.07) 0%, transparent 70%),
            radial-gradient(ellipse 40% 40% at 30% 70%, rgba(139,92,246,0.05) 0%, transparent 60%),
            radial-gradient(ellipse 40% 40% at 70% 30%, rgba(99,102,241,0.04) 0%, transparent 60%)
          `,
        }}
      />
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(18,8,74,0.5) 0%, rgba(30,16,160,0.15) 50%, rgba(15,8,64,0.5) 100%)',
            border: '1px solid rgba(167,139,250,0.15)',
            boxShadow: '0 0 60px rgba(139,92,246,0.06), 0 8px 32px rgba(0,0,0,0.3)',
          }}
        >
          {/* Inner glow */}
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(167,139,250,0.06) 0%, transparent 60%)',
            }}
          />
          ...
          <div className="relative flex flex-col items-center text-center gap-5">
            ...
            <div className="flex items-center gap-3">
              <span
                className="text-[11px] sm:text-xs font-semibold uppercase tracking-[0.15em] px-3 py-1 rounded-full"
                style={{
                  color: '#a78bfa',
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 text-[14px] font-semibold px-8 py-3 rounded-full transition-all duration-300 active:scale-[0.97] hover:shadow-[0_0_30px_rgba(139,92,246,0.3)]"
              style={{
