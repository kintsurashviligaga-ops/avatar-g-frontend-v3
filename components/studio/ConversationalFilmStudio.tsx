...
> = {
  ka: {
    ...
    ready: 'შენი ფილმი მზად არის — იხილე ქვემოთ.',
    ...
    masterReady: 'მასტერი მზად არის · ფილმი',
    ...
    freeFilmNote: 'პირველი ფილმი სრულიად უფასოა — ღირებულებას ფარავს Founder-ბონუსი. შემდეგი ვიდეოები დაიანგარიშება ჩვეულებრივი ფასით.',
    ...
    writingStoryboard: 'სცენარი იწერება — სცენების რეჟისურა…',
  },
  en: {
    ...
    ready: 'Your film is ready — see below.',
    ...
    freeFilmNote: 'Your first film is completely free — the founder bonus covers its cost. Subsequent videos are metered at the normal rate.',
    ...
    newFilm: 'New film',
    tryAgain: 'Try again',
    writingStoryboard: 'Writing the script — directing the scenes…',
  },
  ru: {
    ...
    ready: 'Ваш фильм готов — смотрите ниже.',
    ...
    masterReady: 'Мастер готов · фильм',
    ...
    freeFilmNote: 'Ваш первый фильм совершенно бесплатен — стоимость покрывает Founder-бонус. Последующие видео считаются по обычному тарифу.',
    ...
    newFilm: 'Новый фильм',
    tryAgain: 'Повторить',
    writingStoryboard: 'Пишется сценарий — режиссура сцен…',
  },
};
...
function FilmPreviewPlayer({
  ...
  const handleShare = useCallback(async () => {
    ...
    try {
      if (nav?.share) {
        await nav.share({ title: 'MyAvatar — film', url });
        return;
      }
    } catch {
