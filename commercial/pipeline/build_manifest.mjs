...
const statusOf = (s) =>
  s.live_ui_verified ? `🟢 UI live-verified ${s.live_ui_verified} · recording pending` : '⏳ pending asset';
const row = (s) =>
...
> 🟢 = live UI end-to-end VERIFIED against production (${Object.keys(LIVE_VERIFIED).length} beats, see \`CAPTURE_LOG.md\`) — the interface is confirmed; the frame-exact recording is still pending. ⏳ = asset not yet produced.
